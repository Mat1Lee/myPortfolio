import { faGithub, faLinkedin, faFacebook, faGit, faTwitch, faInstagram, faLinkedinIn } from '@fortawesome/free-brands-svg-icons';
import { faDownload,faFileDownload,faTshirt } from '@fortawesome/free-solid-svg-icons';
...
const Home = () => {
 ...
 obj1.map((item)=>{
  ...
  const searchRange =(target)=>{
    ...
    nums.map((item,index)=>{
        if(item == target){arr7=[...arr7,index]}   
        else arr7=[-1,-1]
    })
    console.log(arr7); 
}
          ...
          <div className=" col-md-6">
            <div style={{ height: '100vh', marginTop: '-56px' }}>
              <div className="home-content-container h-100 d-flex flex-column align-items-center justify-content-center">
                ...
                <a target="_blank" href="https://drive.google.com/file/d/1rVotItzMN9VZzeRVWQ0I3jwETY5Tvpve/view?usp=sharing"><button className="btn brand-btn">Download Resume <span><FontAwesomeIcon icon={faFileDownload}></FontAwesomeIcon></span></button></a>
                ...
                <div class="socialTab">
                  ...
                  <div class="button">
                    <div class="icon">
                      <a href="https://www.linkedin.com/in/m%E1%BA%A1nh-l%C3%AA-bb2586258/" ><FontAwesomeIcon className="myicon" icon={faLinkedinIn}></FontAwesomeIcon></a>
