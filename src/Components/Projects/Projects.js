...
const Projects = () => {
  const projects = [
    ...
    {img: phimchill,livesite:'https://master--phimchilll.netlify.app/', title: 'phim chill', description:'Movie website that recommends trending and top-rated movies and TV series', technology:['REACT','TYPESCRIPT','SCSS', 'REACTBOOTSTRAP', ],github:'https://github.com/Mat1Lee/MovieFlix-main' },
